...
int main()
{
    ...
    Shader lightingShader("./2.-Iluminacion/4.3.-LanzadorLuz/material.vs", "./2.-Iluminacion/4.3.-LanzadorLuz/material.fs");
    Shader lightingCuboShader("./2.-Iluminacion/4.3.-LanzadorLuz/luz.vs", "./2.-Iluminacion/4.3.-LanzadorLuz/luz.fs");
    ...
    unsigned int diffuseMap = cargarImagen("./textura/container2.png");
    unsigned int speculeMap = cargarImagen("./textura/container2_specular.png");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightingShader.use();
        lightingShader.setVec3("light.direction", 1.2f, 1.0f, 2.0f);
        ...
        glm::mat4 projection = glm::perspective(glm::radians(camara.Zoom), 800.0f / 600.0f, 0.1f, 100.0f);
        ...
        glBindTexture(GL_TEXTURE_2D, speculeMap);
        ...
        //lightingCuboShader.use();
        //lightingCuboShader.setMat4("projection", projection);
        //lightingCuboShader.setMat4("view", view);
        //model = glm::mat4(1.0f);
        //model = glm::translate(model, lightPos);
        //model = glm::scale(model, glm::vec3(0.2f));
        //lightingCuboShader.setMat4("model", model);
