...
int main()
{
    ...
    Shader lightingShader("./2.-Iluminacion/4.4.-LucesPuntuales/material.vs", "./2.-Iluminacion/4.4.-LucesPuntuales/material.fs");
    Shader lightingCuboShader("./2.-Iluminacion/4.4.-LucesPuntuales/luz.vs", "./2.-Iluminacion/4.4.-LucesPuntuales/luz.fs");
