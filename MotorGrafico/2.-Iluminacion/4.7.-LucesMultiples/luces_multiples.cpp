...
int main()
{
    ...
    Shader lightingShader("./2.-Iluminacion/4.7.-LucesMultiples/material.vs", "./2.-Iluminacion/4.7.-LucesMultiples/material.fs");
    Shader lightingCuboShader("./2.-Iluminacion/4.7.-LucesMultiples/luz.vs", "./2.-Iluminacion/4.7.-LucesMultiples/luz.fs");
