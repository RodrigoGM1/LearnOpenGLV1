...
int main()
{
    ...
    Shader lightingShader("./2.-Iluminacion/4.1.-LuzMapa/material.vs", "./2.-Iluminacion/4.1.-LuzMapa/material.fs");
    Shader lightingCuboShader("./2.-Iluminacion/4.1.-LuzMapa/luz.vs", "./2.-Iluminacion/4.1.-LuzMapa/luz.fs");
