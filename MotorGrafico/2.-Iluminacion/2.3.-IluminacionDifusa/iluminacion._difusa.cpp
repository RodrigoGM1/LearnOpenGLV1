...
int main()
{
    ...
    Shader lightingShader("./2.-Iluminacion/2.3.-IluminacionDifusa/color.vs", "./2.-Iluminacion/2.3.-IluminacionDifusa/color.fs");
    Shader lightingCuboShader("./2.-Iluminacion/2.3.-IluminacionDifusa/cubo.vs", "./2.-Iluminacion/2.3.-IluminacionDifusa/cubo.fs");
