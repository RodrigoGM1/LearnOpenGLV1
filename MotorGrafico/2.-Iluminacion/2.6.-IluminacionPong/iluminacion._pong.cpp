...
int main()
{
    ...
    Shader lightingShader("./2.-Iluminacion/2.6.-IluminacionPong/color.vs", "./2.-Iluminacion/2.6.-IluminacionPong/color.fs");
    Shader lightingCuboShader("./2.-Iluminacion/2.6.-IluminacionPong/cubo.vs", "./2.-Iluminacion/2.6.-IluminacionPong/cubo.fs");
