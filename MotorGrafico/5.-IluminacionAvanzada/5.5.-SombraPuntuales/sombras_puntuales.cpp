...
int main()
{
    ...
    Shader shader("./5.-IluminacionAvanzada/5.4.-RepresentacionSombras/sombreado.vs", "./5.-IluminacionAvanzada/5.4.-RepresentacionSombras/sombreado.fs");
...
// camera
CamaraClass camera(glm::vec3(0.0f, 0.0f, 3.0f));
...
int main()
{
    ...
    // load textures
    // -------------
    unsigned int woodTexture = loadTexture("./textura/wood.png");
