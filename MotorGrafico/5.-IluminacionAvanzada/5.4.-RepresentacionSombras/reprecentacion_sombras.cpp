...
int main()
{
    ...
    Shader simpleDepthShader("./5.-IluminacionAvanzada/5.4.-RepresentacionSombras/mapeo_sombreado.vs", "./5.-IluminacionAvanzada/5.4.-RepresentacionSombras/mapeo_sombreado.fs");
    Shader debugDepthQuad("5.-IluminacionAvanzada/5.4.-RepresentacionSombras/debug_quad.vs", "5.-IluminacionAvanzada/5.4.-RepresentacionSombras/debug_quad_depth.fs");
    ...
    unsigned int woodTexture = cargarImagen("./textura/wood.png");

    const unsigned int SHADOW_WIDTH = 1024, SHADOW_HEIGTH = 1024;
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT, SHADOW_WIDTH, SHADOW_HEIGTH, 0, GL_DEPTH_COMPONENT, GL_FLOAT, NULL);
...
void renderScene(const Shader& shader) {
    ...
    model = glm::rotate(model, glm::radians(60.f), glm::normalize(glm::vec3(1.0, 1.0, 1.0)));
