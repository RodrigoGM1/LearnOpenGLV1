...
int main()
{
    ...
    Shader shader("./4.OpenGLAvanzado/4.7.-MapaCubico/cubo.vs", "./4.OpenGLAvanzado/4.7.-MapaCubico/cubo.fs");
    Shader skyboxShader("./4.OpenGLAvanzado/4.7.-MapaCubico/mapa_cubo.vs", "./4.OpenGLAvanzado/4.7.-MapaCubico/mapa_cubo.fs");
    ...
    unsigned int cubeTexture = cargarImagen("./textura/container.jpg");

    vector<std::string> faces{
        "./textura/skybox/right.jpg",
        "./textura/skybox/left.jpg",
        "./textura/skybox/top.jpg",
        "./textura/skybox/bottom.jpg",
        "./textura/skybox/front.jpg",
        "./textura/skybox/back.jpg"
    };
...
unsigned int loadCubemap(vector<std::string> faces) {
    ...
    for (unsigned int i = 0; i < faces.size(); i++) {
        ...
        {
            std::cout << "No se pudo cargar la textura CubeMap" << std::endl;
            stbi_image_free(data);
        }
    }
