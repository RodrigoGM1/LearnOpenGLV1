...
int main()
{
    ...
    Shader shader("./4.OpenGLAvanzado/4.8.-MapaCubicoEspejo/cubo.vs", "./4.OpenGLAvanzado/4.8.-MapaCubicoEspejo/cubo.fs");
    Shader skyboxShader("./4.OpenGLAvanzado/4.8.-MapaCubicoEspejo/mapa_cubo.vs", "./4.OpenGLAvanzado/4.8.-MapaCubicoEspejo/mapa_cubo.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shader.setVec3("cameraPos", camara.Position);
