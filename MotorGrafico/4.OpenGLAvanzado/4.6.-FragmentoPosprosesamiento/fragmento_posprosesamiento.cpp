...
int main()
{
    ...
    Shader shader("./4.OpenGLAvanzado/4.6.-FragmentoPosprosesamiento/fragmento_buffer.vs", "./4.OpenGLAvanzado/4.6.-FragmentoPosprosesamiento/fragmento_buffer.fs");
    Shader screenShader("./4.OpenGLAvanzado/4.6.-FragmentoPosprosesamiento/fragmento_buffer_screen.vs", "./4.OpenGLAvanzado/4.6.-FragmentoPosprosesamiento/fragmento_buffer_screen.fs");
    ...
    unsigned int cubeTexture = cargarImagen("./textura/container2.png");
    unsigned int floorTexture = cargarImagen("./textura/metal.png");
    ...
    if (glCheckFramebufferStatus(GL_FRAMEBUFFER) != GL_FRAMEBUFFER_COMPLETE) {
        std::cout << "ERROR::FRAMEBUFFER:: Framebuffer no es completo" << std::endl;
    }
