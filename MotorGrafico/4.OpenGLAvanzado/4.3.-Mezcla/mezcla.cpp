...
int main()
{
    ...
    Shader shader("./4.OpenGLAvanzado/4.3.-Mezcla/mezcla.vs", "./4.OpenGLAvanzado/4.3.-Mezcla/mezcla.fs");
    ...
    unsigned int trasparentTexture = cargarImagen("./textura/grass.png", GL_CLAMP_TO_EDGE);
