...
int main()
{
    ...
    Shader shader("./4.OpenGLAvanzado/4.11.-SombreadoExplo/shader_exploding.vs", "./4.OpenGLAvanzado/4.11.-SombreadoExplo/shader_exploding.fs", "./4.OpenGLAvanzado/4.11.-SombreadoExplo/shader_exploding.gs");
