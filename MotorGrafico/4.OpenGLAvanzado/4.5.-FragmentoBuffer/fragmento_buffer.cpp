...
int main()
{
    ...
    Shader shader("./4.OpenGLAvanzado/4.5.-FragmentoBuffer/fragmento_buffer.vs", "./4.OpenGLAvanzado/4.5.-FragmentoBuffer/fragmento_buffer.fs");
    Shader screenShader("./4.OpenGLAvanzado/4.5.-FragmentoBuffer/fragmento_buffer_screen.vs", "./4.OpenGLAvanzado/4.5.-FragmentoBuffer/fragmento_buffer_screen.fs");
